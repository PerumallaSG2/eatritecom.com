...
export const fallbackMeals = [
  {
    ...
    fat: 22.1,
    ingredients:
      'Sourdough bread, avocado, free-range egg, cherry tomatoes, microgreens, olive oil',
  ...
  },
  {
    ...
    fat: 15.2,
    ingredients:
      'Greek yogurt, mixed berries, granola, almond butter, chia seeds, honey',
    image_url: '/api/placeholder/400/300',
    is_available: true,
  },
  {
    ...
    fat: 28.2,
    ingredients:
      'Atlantic salmon, mixed greens, quinoa, cucumber, cherry tomatoes, lemon vinaigrette',
    image_url: '/api/placeholder/400/300',
    is_available: true,
  },
  {
    ...
    fat: 20.1,
    ingredients:
      'Roasted sweet potato, chickpeas, kale, quinoa, tahini dressing, pumpkin seeds',
    image_url: '/api/placeholder/400/300',
    is_available: true,
  },
  {
    ...
    fat: 22.8,
    ingredients:
      'Organic chicken breast, herb crust, roasted vegetables, sweet potato mash',
    image_url: '/api/placeholder/400/300',
    is_available: true,
  },
]
