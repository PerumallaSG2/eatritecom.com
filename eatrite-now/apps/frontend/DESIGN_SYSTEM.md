...
.card-premium {
  ...
  border-radius: 1rem;
  box-shadow: 0 10px 15px rgba(0,0,0,0.8), 0 0 20px rgba(212,160,71,0.1);
}
...
@keyframes glow {
  0%, 100% { box-shadow: 0 0 20px rgba(212, 160, 71, 0.3); }
  50% { box-shadow: 0 0 30px rgba(212, 160, 71, 0.6); }
}
```
