...
const RevolutionaryMenuPage: React.FC = () => {
  ...
  const revolutionaryMeals = [
    ...
    },
    {
      ...
      fats: 10,
      fiber: 12,
      ingredients: ["Chia Seeds", "Almond Milk", "Fruits", "Coconut", "Vanilla"],
      healthBenefit: "wellness" as const,
      category: "breakfast"
    },
    {
  ...
  const filteredMeals = revolutionaryMeals.filter(meal => {
    const goalMatch = selectedGoal === 'energy' ? true : meal.healthBenefit === selectedGoal;
      ...
      >
        ...
        <div className="relative z-10 pt-20 pb-16 px-6">
          <div className="max-w-7xl mx-auto text-center">
            ...
            >
              Each dish pulses with life energy, adapting to your wellness journey
            </motion.p>
