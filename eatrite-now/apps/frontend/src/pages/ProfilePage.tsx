    ...
    return (
      <div className="min-h-screen bg-gray-50 py-12">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <DietaryProfileSetup onComplete={() => setShowSetup(false)} />
        </div>
      </div>
    )
  }
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-8 mb-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-8 pt-6 border-t border-gray-100">
            ...
            <div className="text-center">
              <div className="text-2xl font-bold text-[#FF6B35] mb-1">12</div>
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="bg-white rounded-xl border border-gray-200 p-8">
              <div className="flex items-center mb-6">
                ...
                <h2 className="text-xl font-semibold text-[#0F2B1E] font-playfair">
                  Dietary Profile
                </h2>
              </div>
              ...
              <div className="space-y-6">
                <div>
                  <h3 className="font-medium text-[#0F2B1E] mb-3">
                    Dietary Restrictions
                  </h3>
                  <div className="flex flex-wrap gap-2">
                    {preferences.dietaryProfile.restrictions.length > 0 ? (
                      preferences.dietaryProfile.restrictions.map(
                        restriction => (
                          <span
                            key={restriction}
                  ...
                  <div className="flex flex-wrap gap-2">
                    {preferences.dietaryProfile.allergies.length > 0 ? (
                      preferences.dietaryProfile.allergies.map(allergy => (
                        <span
                          key={allergy}
                          className="px-4 py-2 bg-red-50 text-red-700 rounded-full text-sm font-medium border border-red-200 flex items-center"
                        >
                  ...
                  <div className="flex flex-wrap gap-2">
                    {preferences.dietaryProfile.goals.length > 0 ? (
                      preferences.dietaryProfile.goals.map(goal => (
                        <span
                          key={goal}
                          className="px-4 py-2 bg-blue-50 text-blue-700 rounded-full text-sm font-medium border border-blue-200 flex items-center"
                        >
          ...
          <div className="space-y-8">
            ...
            <div className="bg-white rounded-xl border border-gray-200 p-6">
              <div className="flex items-center justify-between mb-6">
                <div className="flex items-center">
                  ...
                  <h2 className="text-lg font-semibold text-[#0F2B1E] font-playfair">
                    Current Plan
                  </h2>
                </div>
                <button className="text-[#D4B46A] hover:text-[#b8986b] transition-colors text-sm font-medium">
              ...
              <div className="space-y-4">
                <div className="flex justify-between items-center py-2">
                  ...
                  <span className="font-semibold text-[#0F2B1E]">
                    {preferences.mealPlanPreferences.mealsPerWeek}
                  </span>
                </div>
                <div className="flex justify-between items-center py-2 border-t border-gray-100">
                  <span className="text-gray-600">Delivery day</span>
                  <span className="font-semibold text-[#0F2B1E]">
                    {preferences.mealPlanPreferences.deliveryDay}
                  </span>
                </div>
                <div className="flex justify-between items-center py-2 border-t border-gray-100">
                  <span className="text-gray-600">Portion size</span>
                  <span className="font-semibold text-[#0F2B1E] capitalize">
                    {preferences.mealPlanPreferences.portion}
                  </span>
                </div>
                <div className="flex justify-between items-center py-2 border-t border-gray-100">
                  <span className="text-gray-600">Variety level</span>
                  <span className="font-semibold text-[#0F2B1E] capitalize">
                    {preferences.mealPlanPreferences.variety}
                  </span>
                </div>
              </div>
              ...
              <div className="mt-6 pt-6 border-t border-gray-200">
                ...
                <div className="text-lg font-semibold text-[#0F2B1E]">
                  Wednesday, Jan 24
                </div>
            ...
            <div className="bg-white rounded-xl border border-gray-200 p-6">
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between py-2">
                  ...
                  <div
                    className={`w-11 h-6 rounded-full ${preferences.notifications.email ? 'bg-[#D4B46A]' : 'bg-gray-300'} flex items-center transition-colors cursor-pointer`}
                  >
                    <div
                      className={`w-5 h-5 bg-white rounded-full shadow transform transition-transform ${preferences.notifications.email ? 'translate-x-5' : 'translate-x-0'}`}
                    />
                  </div>
                </div>
                <div className="flex items-center justify-between py-2">
                  ...
                  <div
                    className={`w-11 h-6 rounded-full ${preferences.notifications.push ? 'bg-[#D4B46A]' : 'bg-gray-300'} flex items-center transition-colors cursor-pointer`}
                  >
                    <div
                      className={`w-5 h-5 bg-white rounded-full shadow transform transition-transform ${preferences.notifications.push ? 'translate-x-5' : 'translate-x-0'}`}
                    />
                  </div>
                </div>
                <div className="flex items-center justify-between py-2">
                  ...
                  <div
                    className={`w-11 h-6 rounded-full ${preferences.notifications.sms ? 'bg-[#D4B46A]' : 'bg-gray-300'} flex items-center transition-colors cursor-pointer`}
                  >
                    <div
                      className={`w-5 h-5 bg-white rounded-full shadow transform transition-transform ${preferences.notifications.sms ? 'translate-x-5' : 'translate-x-0'}`}
                    />
                  </div>
                </div>
              </div>
            ...
            <div className="bg-gradient-to-br from-[#F5F2E8] to-[#F5EEDC] rounded-xl p-6 border border-[#D4B46A]/30">
              <div className="text-center">
                ...
                <h3 className="font-semibold text-[#0F2B1E] mb-2 font-playfair">
                  Wellness Champion
                </h3>
