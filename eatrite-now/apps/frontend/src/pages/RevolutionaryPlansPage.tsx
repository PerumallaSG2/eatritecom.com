        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            {filteredPlans.map((plan, index) => (
              ...
              >
                ...
                {plan.badge && (
                  <div
                    className={`absolute top-4 right-4 px-3 py-1 rounded-full text-xs font-bold text-white ${plan.badgeColor}`}
                  >
                    {plan.badge}
                  </div>
                )}
          ...
          >
            ...
            <h3 className="text-2xl font-bold text-white mb-4">
              30-Day Living Food Guarantee
            </h3>
            <p className="text-white/70 max-w-2xl mx-auto">
              If you don't feel the transformative power of our living meals
              within 30 days, we'll refund your entire purchase. No questions
              asked.
            </p>
          </motion.div>
        </div>
