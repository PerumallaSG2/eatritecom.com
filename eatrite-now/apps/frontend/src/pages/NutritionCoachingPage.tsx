  ...
  const dietitians = [
    {
      ...
      description:
        'Valentina specializes in sports nutrition and sustainable weight management. She believes in flexible eating approaches and evidence-based strategies for long-term health success.',
      image:
    ...
    },
    {
      ...
      description:
        'DeAndrea promotes flexible eating without rigid restrictions, focusing on balanced nutrition for sustainable lifestyle changes and optimal health outcomes.',
      image:
    ...
    },
    {
      ...
      description:
        'Jordan focuses on behavioral change and sustainable habits. She helps clients develop healthy relationships with food through evidence-based counseling techniques.',
      image:
        'https://images.unsplash.com/photo-1594824942280-d4fee3dee5f5?w=400&h=400&fit=crop&auto=format',
      rating: 4.9,
      sessions: 380,
    },
  ]
    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="container">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
              Work with registered dietitians to create personalized nutrition
              plans that fit your lifestyle. Get the guidance and support you
              need to achieve lasting health results.
            </p>
        ...
        <div className="container">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600">
              Flexible options to match your needs and goals
            </p>
          </div>
      ...
      <section className="section section-alternate">
        <div className="container">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold mb-4 text-gray-800">
              Meet Your Expert Dietitians
            </h2>
            <p className="text-gray-600">
              Registered professionals with specialized expertise in nutrition
              and wellness
            </p>
          </div>
      ...
      <section className="section section-alternate">
        <div className="container">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600">
              Real results from real people working with our nutrition experts
            </p>
          </div>
      ...
      <section className="section section-hero">
        <div className="container text-center">
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
            ...
            nutrition coaching from registered dietitians who care about your
            success.
          </p>
