  ...
  return (
    <div className="min-h-screen bg-[#F5EEDC]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <FadeIn>
          <div className="mb-8">
            <h1 className="text-3xl font-semibold text-[#0F2B1E] mb-3 font-playfair">
              Account Overview
            </h1>
            <p className="text-gray-600 max-w-2xl">
              Manage your subscription, track orders, and customize your EatRite
              experience
            </p>
          </div>
        </FadeIn>
                ...
                {tabItems.map(({ id, label, icon: Icon }) => (
                  ...
                  >
                    <div className="flex items-center space-x-3">
                      ...
                      >
                        <Icon
                          className={`w-4 h-4 ${activeTab === id ? 'text-[#D4B46A]' : 'text-gray-500'}`}
                        />
                      </div>
...
const ProfileOverview: React.FC = () => {
  return (
    <div className="space-y-8">
      ...
      <div className="bg-white rounded-xl border border-gray-200 p-8">
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6 mb-8">
          <div className="flex items-center space-x-6">
            ...
            <div>
              <h2 className="text-3xl font-semibold text-[#0F2B1E] mb-2 font-playfair">
                John Doe
              </h2>
      ...
      <div className="bg-white rounded-xl border border-gray-200 p-8">
        <h3 className="text-xl font-semibold text-[#0F2B1E] mb-6 font-playfair">
          Quick Actions
        </h3>
      ...
      <div className="bg-white rounded-xl border border-gray-200 p-8">
        <div className="flex items-center justify-between mb-6">
          <h3 className="text-xl font-semibold text-[#0F2B1E] font-playfair">
            Recent Activity
          </h3>
        ...
        <div className="space-y-4">
          <div className="flex items-start space-x-4 p-4 bg-green-50 rounded-lg border border-green-200">
            ...
            <div className="flex-1">
              ...
              <p className="text-sm text-green-600 mt-1">
                3 meals from Chef's Signature collection
              </p>
          ...
          <div className="flex items-start space-x-4 p-4 bg-blue-50 rounded-lg border border-blue-200">
            ...
            <div className="flex-1">
              ...
              <p className="text-sm text-blue-600 mt-1">
                Added new Visa card ending in 4242
              </p>
          ...
          <div className="flex items-start space-x-4 p-4 bg-[#F5F2E8] rounded-lg border border-[#D4B46A]/30">
            ...
            <div className="flex-1">
              <p className="font-medium text-[#0F2B1E]">
                Referral reward earned: $15
              </p>
              <p className="text-sm text-gray-600 mt-1">
                Sarah M. joined using your referral link
              </p>
          ...
          <div className="flex items-start space-x-4 p-4 bg-gray-50 rounded-lg border border-gray-200">
            ...
            <div className="flex-1">
              ...
              <p className="text-sm text-gray-600 mt-1">
                Added gluten-free to restrictions
              </p>
              <p className="text-xs text-gray-500 mt-2">
            ...
            >
              <div className="flex-1">
                ...
                <p className="text-sm text-gray-600 leading-relaxed">
                  {key === 'orderUpdates' &&
                    'Receive real-time updates about your order status, delivery tracking, and meal preparation'}
                  {key === 'promotions' &&
                    'Get notified about special offers, seasonal discounts, and exclusive member benefits'}
                  {key === 'newsletters' &&
                    'Weekly curated content with new recipes, nutrition tips, and meal recommendations'}
                  {key === 'sms' &&
                    'Urgent notifications via text message for delivery updates and account security'}
                </p>
              </div>
              <button
                onClick={() =>
