...
const LeafIcon = ({ className = 'w-6 h-6' }) => (
  ...
  >
    <path
      ...
      strokeWidth={2}
      d="M5 3l3.5 3.5M9 21a9 9 0 110-18 9 9 0 010 18zM15 9a9 9 0 11-6-6 9 9 0 016 6z"
    />
  </svg>
)
    ...
    const fetchPopularMeals = async () => {
      try {
        const response = await fetch(
          buildApiUrl('/api/meals?popular=true&limit=6')
        )
        if (response.ok) {
  ...
  const testimonials = [
    {
      ...
      role: 'Wellness Coach',
      content:
        'EatRite transformed my relationship with food. The quality is exceptional!',
      rating: 5,
    },
    {
      name: 'Marcus Johnson',
      ...
      content:
        'Perfect macros, incredible taste. This is the future of healthy eating.',
      rating: 5,
    },
    {
      ...
      role: 'Nutritionist',
      content:
        'I recommend EatRite to all my clients. Pure ingredients, expert preparation.',
      rating: 5,
    },
  ]
          ...
          <div className="grid-2" style={{ alignItems: 'center' }}>
            ...
            <div>
              ...
              <p className="text-lg mb-6">
                Our meals are designed to provide the nutrientous you need to
                thrive .. to mear.
              </p>
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <p className="text-muted">
                    Our meals are designed to provide the nutrients you need to
                    thrive.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-muted">
                    Experience the benefits of eating well with chef-crafted
                    meals.
                  </p>
                </div>
              </div>
        ...
        <div className="container">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Chef-crafted meals designed to fuel your body and delight your
              taste buds
            </p>
          </div>
        ...
        <div className="container">
          ...
          <div className="feature-grid">
            <div className="card text-center p-8 hover-glow animate-fade-in-up">
              ...
              <div className="text-gray-600 uppercase tracking-wide font-medium">
                Premium Meals
              </div>
            </div>
      ...
      <section className="section section-alternate">
        <div className="container">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Premium meal plans crafted for the discerning palate. Complete
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="card p-8 text-center hover-lift">
              <div className="mb-6">
                ...
                <p className="text-gray-600">
                  Perfect for trying our luxury cuisine
                </p>
              </div>
            ...
            <div className="card p-8 text-center relative transform scale-105 border-2 border-orange-500 hover-lift">
              ...
              <div className="mb-6">
                ...
                <p className="text-gray-600">
                  Optimal luxury dining experience
                </p>
              </div>
        ...
        <div className="container">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-xl mb-12 text-green-100 leading-relaxed">
              ...
              health, and convenience. Start your journey to better health
              today.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center">
              ...
              <Link
                to="/menu"
                className="btn btn-ghost btn-lg text-white border-white hover:bg-white hover:text-green-700"
              >
                Explore Menu
              </Link>
            </div>
