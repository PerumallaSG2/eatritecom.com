...
export const touchInteractionClasses = {
  ...
  touchButton: "touch-manipulation select-none active:scale-95 transition-transform duration-150",
  
  // Card that responds to touch
  touchCard: "touch-manipulation active:scale-98 transition-all duration-200 cursor-pointer",
  
  // Large touch target (minimum 44px)
  touchTarget: "min-h-[44px] min-w-[44px] touch-manipulation",
  
  // Ripple effect on touch
  touchRipple: "relative overflow-hidden before:absolute before:inset-0 before:bg-white/20 before:scale-0 before:rounded-full active:before:scale-100 before:transition-transform before:duration-300",
