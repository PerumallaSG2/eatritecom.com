  ...
  return [
    {
      ...
      content: 'As a working mom, Factor75 has been a lifesaver. The Mediterranean Salmon was restaurant-quality, and my kids actually asked for seconds. The convenience is unmatched!',
    ...
    },
    {
      ...
      content: 'The macros are spot-on for my training. Lost 12 lbs in 6 weeks while gaining muscle. The Keto Power Bowl is my go-to post-workout meal.',
      ...
      response: {
        ...
        content: 'Amazing results, Marcus! We\'re thrilled to be part of your fitness journey. Keep up the great work!',
    ...
    },
    {
      ...
      content: 'I\'ve been ordering for over a year now. The quality is consistent, ingredients are fresh, and the variety keeps meals exciting. Worth every penny!',
      mealName: 'Paleo Chicken Harvest Bowl',
      mealImage: '🍗',
      timestamp: new Date(Date.now() - 45 * 60 * 1000),
      helpful: 67,
      images: ['paleo1.jpg', 'paleo2.jpg', 'paleo3.jpg'],
      tags: ['loyal-customer', 'consistent-quality', 'paleo', 'fresh-ingredients']
    },
    {
      id: '4',
      customer: {
      ...
      content: 'The Tex-Mex Bowl was delicious with perfect spice levels. One container arrived slightly damaged but customer service was quick to resolve it.',
    ...
    },
    {
      ...
      content: 'Finally found a meal service that takes vegetarian seriously. The Mushroom & Quinoa Bowl is packed with flavor and keeps me full for hours.',
    ...
    },
    {
      ...
      content: 'Working from home made me lazy with meals. Factor75 ensures I eat well without spending time cooking. The BBQ Pork is incredible!',
  ...
  useEffect(() => {
    ...
    const interval = setInterval(() => {
      const newReview: Review = {
        ...
        content: 'Really impressed with the quality and taste. Will definitely order again!',
  ...
  const applyFilter = () => {
    ...
    switch (filter) {
      ...
      case 'photos':
        ...
        break;
      case 'recent':
        filtered = reviews.sort((a, b) => b.timestamp.getTime() - a.timestamp.getTime()).slice(0, 5);
        break;
      default:
        filtered = reviews;
    }
        ...
        <FadeIn>
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h2 className="text-2xl font-bold">Real-Time Customer Reviews</h2>
                <p className="text-green-100">Live feedback from verified customers</p>
              </div>
            </div>
                  ...
                  <div className="mt-4 p-4 bg-green-50 rounded-lg border-l-4 border-green-500">
                    <div className="flex items-center space-x-2 mb-2">
                      <div className="w-6 h-6 bg-green-600 rounded-full flex items-center justify-center">
                        <span className="text-white text-xs font-bold">F75</span>
                      </div>
                      <span className="font-semibold text-green-800">{review.response.from}</span>
                      <span className="text-sm text-gray-500">
