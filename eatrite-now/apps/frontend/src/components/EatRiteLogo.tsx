...
const EatRiteLogo: React.FC<EatRiteLogoProps> = ({
  ...
  if (variant === 'full') {
    return (
      <div className={`flex items-center gap-sm ${className}`}>
        <div
          className={`${sizeClasses[size]} ${animated ? 'animate-pulse-gold' : ''}`}
        >
          <svg viewBox="0 0 200 200" className="w-full h-full" fill="none">
            ...
            {/* Center leaf */}
            <path
              d="M100 60 Q85 80 100 120 Q115 80 100 60 Z"
              fill="url(#luxuryGold)"
              filter="url(#goldGlow)"
            />
            ...
            {/* Side leaves */}
            <path
              d="M70 100 Q60 85 80 75 Q90 90 70 100 Z"
              fill="url(#luxuryGold)"
              opacity="0.8"
            />
            <path
              d="M130 100 Q140 85 120 75 Q110 90 130 100 Z"
              fill="url(#luxuryGold)"
              opacity="0.8"
            />
        ...
        <span className={`heading-3 text-accent ${textSizeClasses[size]}`}>
          EatRite
        </span>
      </div>
    )
  ...
  return (
    <div
      className={`${sizeClasses[size]} ${animated ? 'animate-pulse-gold' : ''} ${className}`}
    >
      <svg viewBox="0 0 200 200" className="w-full h-full" fill="none">
        <defs>
