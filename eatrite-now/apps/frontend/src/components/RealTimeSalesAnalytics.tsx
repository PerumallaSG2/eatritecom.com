            ...
            <div className="bg-white rounded-2xl p-6 shadow-lg">
              <div className="flex items-center justify-between mb-6">
                ...
                <div className="text-sm text-gray-500">
                  Total: {formatCurrency(getTotalRevenue())} •{' '}
                  ...
                  >
                    ...
                    <div className="grid grid-cols-4 gap-4 text-sm">
                      <div>
                        ...
                        <div
                          className={`font-semibold ${product.growth > 0 ? 'text-green-600' : 'text-red-600'}`}
                        >
                          +{product.growth}%
                        </div>
                      </div>
                      ...
                      <div>
                        ...
                        <div
                          className={`font-semibold ${product.inventory < 50 ? 'text-red-600' : 'text-green-600'}`}
                        >
                          {product.inventory}
                        </div>
                      </div>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-lg">
              ...
              <div className="space-y-4">
                {channelPerformance.map((channel, _index) => (
                  <div
                    key={channel.channel}
                    className={`p-4 bg-${channel.color}-50 rounded-lg border border-${channel.color}-100`}
                  >
                    <div className="flex items-center justify-between mb-3">
                      <h4 className="font-semibold text-gray-900">
                        {channel.channel}
                      ...
                      <div className="text-right">
                        <div
                          className={`font-semibold text-${channel.color}-600`}
                        >
                    ...
                    <div className="grid grid-cols-4 gap-3 text-sm">
                      ...
                      <div>
                        ...
                        <div
                          className={`font-semibold ${channel.roi > 200 ? 'text-green-600' : 'text-yellow-600'}`}
                        >
                          {channel.roi}%
                        </div>
                      </div>
              ...
              <div className="mt-6 p-4 bg-gradient-to-r from-indigo-50 to-purple-50 rounded-lg border border-indigo-200">
                <div className="text-center">
                  <div className="text-2xl font-bold text-indigo-600">
                    {formatCurrency(
                      channelPerformance.reduce((sum, c) => sum + c.revenue, 0)
                    )}
                  </div>
                  <div className="text-sm text-gray-700">
                  ...
                  <div className="text-xs text-gray-600 mt-1">
                    {channelPerformance.reduce((sum, c) => sum + c.orders, 0)}{' '}
                    total orders
                  </div>
                </div>
              </div>
