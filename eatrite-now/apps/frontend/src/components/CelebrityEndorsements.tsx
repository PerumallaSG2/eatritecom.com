...
const celebrities: Celebrity[] = [
  {
    ...
    avatar: '🏈',
    testimonial: "Factor75 keeps me performing at my peak. The nutrition is exactly what my body needs for recovery and sustained energy.",
    rating: 5,
    followers: '12M',
    verified: true,
    ...
    category: 'athlete',
    achievements: ['7x Super Bowl Champion', 'TB12 Method Founder', 'Longevity Expert']
  },
  {
    id: '2',
    ...
    avatar: '🎬',
    testimonial: "As someone who's always on set, Factor75 gives me the clean eating I need without the prep time. It's been a game-changer!",
    rating: 5,
    followers: '41M',
    verified: true,
    socialMedia: {
  ...
  },
  {
    ...
    avatar: '📚',
    testimonial: "I've tested thousands of optimization strategies. Factor75's approach to nutrition science and convenience is unmatched.",
    rating: 5,
    followers: '2.1M',
    verified: true,
    socialMedia: {
  ...
  },
  {
    ...
    avatar: '🎾',
    testimonial: "Nutrition is crucial for athletic performance. Factor75 delivers restaurant-quality meals that fuel my training and recovery.",
    rating: 5,
    followers: '15M',
    verified: true,
    socialMedia: {
    ...
    category: 'athlete',
    achievements: ['23x Grand Slam Champion', 'Olympic Gold Medalist', 'Tennis Legend']
  },
  {
    id: '5',
    name: 'Gordon Ramsay',
    ...
    avatar: '👨‍🍳',
    testimonial: "The quality and flavor profiles in Factor75 meals are exceptional. It's restaurant-caliber food delivered to your door.",
    rating: 5,
    followers: '32M',
    verified: true,
    socialMedia: {
    ...
    category: 'chef',
    achievements: ['Michelin Star Chef', 'TV Personality', 'Restaurant Empire Owner']
  }
];
...
export const CelebrityEndorsements: React.FC = () => {
  ...
  const prevCelebrity = () => {
    setCurrentCelebrity((prev) => (prev - 1 + celebrities.length) % celebrities.length);
  };
              ...
              <div className="text-center lg:text-left">
                <div className="flex items-center justify-center lg:justify-start space-x-4 mb-4">
                  ...
                  <div>
                    ...
                    <div className={`inline-block px-3 py-1 rounded-full text-sm font-semibold mt-2 ${getCategoryColor(celebrity.category)}`}>
                ...
                <div className="flex items-center justify-center lg:justify-start space-x-4 mb-4">
                  {celebrity.socialMedia.instagram && (
                    <div className="flex items-center space-x-2 text-pink-400">
                      ...
                      <span className="text-sm">{celebrity.followers} followers</span>
                    </div>
                  )}
                  {celebrity.socialMedia.twitter && (
                    <div className="flex items-center space-x-2 text-blue-400">
                      <Twitter className="w-5 h-5" />
                      <span className="text-sm">@{celebrity.name.replace(' ', '').toLowerCase()}</span>
                    </div>
                  )}
                </div>
                  ...
                  <div className="flex">
                    {[...Array(5)].map((_, i) => (
                      <Star
                        key={i}
                        className={`w-6 h-6 ${
                          i < celebrity.rating ? 'text-yellow-400 fill-current' : 'text-gray-500'
                        }`}
                      />
                    ))}
                  </div>
        ...
        <FadeIn delay={0.3}>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 bg-white/10 backdrop-blur-sm rounded-xl p-6">
            <div className="text-center">
              <div className="text-2xl font-bold text-yellow-400">{celebrities.length}</div>
