...
export const EatRiteIcon: React.FC<IconProps> = ({ 
  ...
  return (
    ...
    >
      ...
      />
      {/* Bowl Rim Highlight */}
      <ellipse cx="12" cy="11" rx="8" ry="1" fill="currentColor" opacity="0.3" />
    </svg>
  );
};

// Nutrition Icons
export const ProteinIcon: React.FC<IconProps> = ({ size = 'md', color = 'gold', className = '' }) => (
  <svg width={iconSizes[size]} height={iconSizes[size]} viewBox="0 0 24 24" className={className} style={{ color: iconColors[color] }}>
    <path d="M12 2L15.09 8.26L22 9L17 14L18.18 21L12 17.77L5.82 21L7 14L2 9L8.91 8.26L12 2Z" fill="currentColor" />
  </svg>
);

export const CarbIcon: React.FC<IconProps> = ({ size = 'md', color = 'gold', className = '' }) => (
  <svg width={iconSizes[size]} height={iconSizes[size]} viewBox="0 0 24 24" className={className} style={{ color: iconColors[color] }}>
...
export const FatIcon: React.FC<IconProps> = ({ size = 'md', color = 'gold', className = '' }) => (
  <svg width={iconSizes[size]} height={iconSizes[size]} viewBox="0 0 24 24" className={className} style={{ color: iconColors[color] }}>
    <path d="M12 2C13.1 2 14 2.9 14 4C14 5.1 13.1 6 12 6C10.9 6 10 5.1 10 4C10 2.9 10.9 2 12 2ZM21 9V7L15 13L13.5 7.5C13.1 6.4 12.1 5.5 11 5.5S8.9 6.4 8.5 7.5L7 13L1 7V9L6 13.5V22H8.5V13.5L9.5 9.5L11 15V22H13V15L14.5 9.5L15.5 13.5V22H18V13.5L23 9Z" fill="currentColor" />
  </svg>
);

// Utility Icons
export const LeafIcon: React.FC<IconProps> = ({ size = 'md', color = 'gold', className = '' }) => (
  <svg width={iconSizes[size]} height={iconSizes[size]} viewBox="0 0 24 24" className={className} style={{ color: iconColors[color] }}>
    <path d="M17 8C8 10 5.9 16.17 3.82 21.34L5.71 22L6.66 19.7C7.14 19.87 7.64 20 8 20C19 20 22 3 22 3C21 5 14 5.25 9 6.25C4 7.25 2 11.5 2 13.5C2 15.5 3.75 17 6.5 17C9.25 17 12 15 13 12C14 9 17 8 17 8Z" fill="currentColor" />
  </svg>
);

export const CalendarIcon: React.FC<IconProps> = ({ size = 'md', color = 'gold', className = '' }) => (
  <svg width={iconSizes[size]} height={iconSizes[size]} viewBox="0 0 24 24" className={className} style={{ color: iconColors[color] }}>
...
export const CartIcon: React.FC<IconProps> = ({ size = 'md', color = 'gold', className = '' }) => (
  <svg width={iconSizes[size]} height={iconSizes[size]} viewBox="0 0 24 24" className={className} style={{ color: iconColors[color] }}>
...
export const UserIcon: React.FC<IconProps> = ({ size = 'md', color = 'gold', className = '' }) => (
  <svg width={iconSizes[size]} height={iconSizes[size]} viewBox="0 0 24 24" className={className} style={{ color: iconColors[color] }}>
...
export const SearchIcon: React.FC<IconProps> = ({ size = 'md', color = 'gold', className = '' }) => (
  <svg width={iconSizes[size]} height={iconSizes[size]} viewBox="0 0 24 24" className={className} style={{ color: iconColors[color] }}>
...
export const EatRiteInput: React.FC<InputProps> = ({
  ...
  const inputStyles: React.CSSProperties = {
    ...
    border: `${focused ? EatRiteDesignTokens.components.input.focusBorderWidth : EatRiteDesignTokens.components.input.borderWidth} solid ${
      error ? EatRiteDesignTokens.colors.semantic.error :
      focused ? EatRiteDesignTokens.colors.primary.gold :
...
export const EatRiteSectionHeader: React.FC<SectionHeaderProps> = ({
  ...
  return (
    <div style={containerStyles} className={className}>
      <div style={{ display: 'flex', alignItems: 'center', gap: EatRiteDesignTokens.spacing.md, flexDirection: centered ? 'column' : 'row' }}>
        {icon && (
...
export const EatRiteTabs: React.FC<TabsProps> = ({
  ...
  const containerStyles: React.CSSProperties = {
    display: 'flex',
    borderBottom: variant === 'underline' ? `1px solid rgba(212, 180, 106, 0.2)` : 'none',
  ...
  const getTabStyles = (isActive: boolean): React.CSSProperties => {
    const baseStyles: React.CSSProperties = {
      ...
      backgroundColor: variant === 'pills' && isActive ? EatRiteDesignTokens.colors.surface.darkGreenLight : 'transparent',
      borderRadius: variant === 'pills' ? EatRiteDesignTokens.borderRadius.lg : 0,
