...
const mockDeliverySchedule: DeliverySchedule[] = [
  {
    ...
    date: '2024-01-22',
    status: 'upcoming',
    meals: ['Grilled Chicken & Vegetables', 'Salmon with Quinoa', 'Beef Steak & Sweet Potato'],
  },
  {
    id: 'delivery-2',
    date: '2024-01-15',
...
export const SubscriptionManagement: React.FC = () => {
  ...
  const [activeTab, setActiveTab] = useState<'overview' | 'billing' | 'delivery'>('overview');
          ...
          <div className="bg-white rounded-lg shadow-md p-6 border-l-4 border-green-500">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-gray-500">{currentPlan.mealsPerWeek} meals/week</p>
              </div>
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <div className="flex items-center space-x-2">
                  <span className={`inline-flex items-center px-2 py-1 rounded-full text-sm font-medium ${getStatusColor(subscriptionStatus)}`}>
                    {getStatusIcon(subscriptionStatus)}
                    <span className="ml-1 capitalize">{subscriptionStatus}</span>
                  </span>
                </div>
              </div>
          ...
          <div className="bg-white rounded-lg shadow-md p-6 border-l-4 border-purple-500">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-lg font-bold text-gray-900">{nextDeliveryDate}</p>
                ...
                >
                  ...
                  <div className="text-center">
                    ...
                    <p className="text-2xl font-bold text-gray-900 mt-2">
                      ...
                      <span className="text-sm font-normal text-gray-600">/serving</span>
                    </p>
                    <p className="text-sm text-gray-600 mt-1">{plan.mealsPerWeek} meals/week</p>
                      ...
                      <div className="bg-gray-50 rounded-lg p-4">
                        <div className="space-y-2">
                          ...
                          <div className="flex justify-between">
                            ...
                            <span className="font-medium">{currentPlan.mealsPerWeek}</span>
                          </div>
                          <div className="flex justify-between">
                            <span className="text-gray-600">Servings:</span>
                            <span className="font-medium">{currentPlan.servings} per meal</span>
                          </div>
                          <div className="flex justify-between">
                            <span className="text-gray-600">Price per serving:</span>
                            <span className="font-medium">${currentPlan.pricePerServing}</span>
                          </div>
                          <div className="flex justify-between border-t pt-2">
                            <span className="text-gray-900 font-semibold">Total per week:</span>
                            <span className="font-bold text-green-600">${currentPlan.totalPrice}</span>
                          </div>
                        </div>
                      </div>
                    </div>
                    <div>
                      <h4 className="font-medium text-gray-900 mb-2">Subscription Stats</h4>
                      <div className="bg-gray-50 rounded-lg p-4">
                        <div className="space-y-2">
                          <div className="flex justify-between">
                        ...
                        {mockBillingHistory.map((bill) => (
                          <tr key={bill.id} className="hover:bg-gray-50">
                            ...
                            <td className="px-6 py-4 whitespace-nowrap text-sm text-blue-600 hover:text-blue-800">
                              <button className="hover:underline">{bill.invoice}</button>
                            </td>
                          </tr>
                        ))}
                      </tbody>
                  ...
                  <div className="space-y-4">
                    {mockDeliverySchedule.map((delivery) => (
                      <div key={delivery.id} className="bg-gray-50 rounded-lg p-4">
                        ...
                        <div>
                          <p className="text-sm text-gray-600 mb-2">Meals included:</p>
