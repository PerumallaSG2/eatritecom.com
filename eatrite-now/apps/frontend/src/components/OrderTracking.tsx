    ...
    items: [
      {
        ...
        image: 'https://images.unsplash.com/photo-1558030006-450675393462?w=100&h=100&fit=crop',
        quantity: 2,
        price: 20.00
      }
    ],
...
export const OrderTracking: React.FC = () => {
  ...
  useEffect(() => {
    if (selectedOrder?.trackingNumber && mockTrackingUpdates[selectedOrder.trackingNumber]) {
          ...
          {selectedOrder ? (
                  ...
                  <div className="p-6 border-b border-gray-200">
                    <div className="flex items-center justify-between mb-4">
                      ...
                      <div className={`flex items-center space-x-2 px-3 py-1 rounded-full border ${getStatusColor(selectedOrder.status)}`}>
                        ...
                        <span className="text-sm font-medium">{formatStatus(selectedOrder.status)}</span>
                      </div>
                    </div>
                    ...
                    <div className="grid grid-cols-2 gap-4 text-sm">
                      ...
                      <div>
                        <p className="text-gray-500">
                          {selectedOrder.status === 'delivered' ? 'Delivered' : 'Expected Delivery'}
                        </p>
            ...
            <FadeIn delay={0.4}>
              <div className="bg-white rounded-lg shadow-md p-8 text-center">
                ...
                <p className="text-gray-500">
                  Click on any order from the list to view detailed tracking information
                </p>
              </div>
            </FadeIn>
          )}
