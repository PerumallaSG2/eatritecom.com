    ...
    <div style={containerStyles}>
      <div style={heroStyles}>
        ...
        <p style={subtitleStyles}>
          Transform your nutrition journey with our premium meal planning and
          wellness platform. Let's create your personalized wellness experience.
        </p>
      </div>
...
export const GoalsScreen: React.FC<GoalsScreenProps> = ({ onNext, onBack }) => {
  ...
  const goals: Goal[] = [
    {
      ...
      description:
        'Reach and maintain your ideal weight with balanced nutrition',
  ...
  const getGoalCardStyles = (isSelected: boolean): React.CSSProperties => ({
    ...
    boxShadow: isSelected
      ? EatRiteDesignTokens.shadows.goldGlow.md
      : EatRiteDesignTokens.shadows.depth.sm,
  })
  ...
  return (
    <div style={containerStyles}>
      <div style={headerStyles}>
        ...
        <p style={subtitleStyles}>
          Select all that apply. We'll customize your meal plans and
...
> = ({ onNext, onBack }) => {
  ...
  const preferences: DietaryPreference[] = [
    ...
    { id: 'paleo', name: 'Paleo', description: 'Whole foods, no grains' },
    {
      id: 'mediterranean',
      name: 'Mediterranean',
      description: 'Fish, vegetables, olive oil',
    },
    {
      id: 'gluten-free',
      name: 'Gluten-Free',
    ...
    { id: 'dairy-free', name: 'Dairy-Free', description: 'No milk products' },
    {
      id: 'low-sodium',
      name: 'Low Sodium',
      description: 'Heart-healthy low salt',
    },
  ]
  ...
  return (
    <div style={containerStyles}>
      <div style={headerStyles}>
        ...
        <p style={subtitleStyles}>
          Let us know about any dietary restrictions or preferences so we can
  ...
  return (
    <div style={containerStyles}>
      <div style={heroStyles}>
        ...
        <p style={subtitleStyles}>
          Your personalized nutrition profile is ready. We'll now create custom
          meal plans tailored specifically to your goals and preferences.
        </p>
      </div>
      ...
      <EatRiteCard variant="luxury" padding="lg" style={summaryCardStyles}>
        ...
        <div style={{ marginBottom: EatRiteDesignTokens.spacing.lg }}>
          ...
          {userData.goals.map(goal => (
            <div key={goal} style={summaryItemStyles}>
              • {goal}
            </div>
          ))}
        </div>
        ...
        {userData.preferences.length > 0 && (
          <div>
            ...
            {userData.preferences.map(pref => (
              <div key={pref} style={summaryItemStyles}>
                • {pref}
              </div>
            ))}
          </div>
