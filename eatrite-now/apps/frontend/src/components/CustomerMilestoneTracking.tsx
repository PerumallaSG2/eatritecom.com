...
const generateMilestones = (progress: UserProgress): Milestone[] => [
  {
    ...
    completedDate: progress.totalMeals >= 1 ? new Date(Date.now() - 30 * 24 * 60 * 60 * 1000) : undefined,
  ...
  },
  {
    ...
    completedDate: progress.totalMeals >= 10 ? new Date(Date.now() - 25 * 24 * 60 * 60 * 1000) : undefined,
  ...
  },
  {
    ...
    completedDate: progress.totalMeals >= 25 ? new Date(Date.now() - 20 * 24 * 60 * 60 * 1000) : undefined,
  ...
  },
  {
    ...
    completedDate: progress.totalMeals >= 50 ? new Date(Date.now() - 15 * 24 * 60 * 60 * 1000) : undefined,
  ...
  },
  {
    ...
    completedDate: progress.currentStreak >= 7 ? new Date(Date.now() - 10 * 24 * 60 * 60 * 1000) : undefined,
  ...
  },
  {
    ...
    completedDate: progress.weightLost >= 10 ? new Date(Date.now() - 12 * 24 * 60 * 60 * 1000) : undefined,
  ...
  },
  {
    ...
    completedDate: progress.moneySaved >= 100 ? new Date(Date.now() - 8 * 24 * 60 * 60 * 1000) : undefined,
  ...
  },
  {
    ...
    completedDate: progress.referrals >= 3 ? new Date(Date.now() - 5 * 24 * 60 * 60 * 1000) : undefined,
...
export const CustomerMilestoneTracking: React.FC = () => {
  ...
  const categories = [
    ...
    { value: 'meals', label: 'Meal Goals', count: milestones.filter(m => m.category === 'meals').length },
    { value: 'health', label: 'Health Goals', count: milestones.filter(m => m.category === 'health').length },
    { value: 'streak', label: 'Streak Goals', count: milestones.filter(m => m.category === 'streak').length },
    { value: 'social', label: 'Social Goals', count: milestones.filter(m => m.category === 'social').length },
    { value: 'savings', label: 'Savings Goals', count: milestones.filter(m => m.category === 'savings').length }
  ];
        ...
        <FadeIn delay={0.1}>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-8">
            ...
            <div className="bg-white rounded-xl p-6 text-center shadow-lg">
              ...
              <div className="text-2xl font-bold text-gray-900">${totalRewardsEarned}</div>
            ...
            <div className="bg-white rounded-xl p-6 text-center shadow-lg">
              ...
              <div className="text-2xl font-bold text-gray-900">{Math.round((completedCount / milestones.length) * 100)}%</div>
          ...
          {filteredMilestones.map((milestone) => {
            ...
            return (
              ...
              >
                {/* Completion Badge */}
                {milestone.isCompleted && (
                  <div className={`absolute -top-2 -right-2 w-8 h-8 bg-${milestone.color}-500 rounded-full flex items-center justify-center`}>
                ...
                <div className="flex items-center space-x-4 mb-4">
                  <div className={`w-12 h-12 bg-${milestone.color}-100 rounded-xl flex items-center justify-center`}>
                    <IconComponent className={`w-6 h-6 text-${milestone.color}-600`} />
                  </div>
                ...
                <div className={`p-3 bg-${milestone.color}-50 rounded-lg mb-4`}>
                  <div className="flex items-center space-x-2">
                    ...
                    <span className={`text-sm font-semibold text-${milestone.color}-700`}>
                ...
                {milestone.isCompleted ? (
                  ...
                  <div className="text-sm text-gray-600">
                    ...
                    {milestone.nextMilestone.title} ({milestone.nextMilestone.target} {milestone.unit})
                  </div>
                ) : null}
              </div>
            );
        ...
        <FadeIn delay={0.5}>
          <div className="mt-8 bg-gradient-to-r from-purple-100 to-pink-100 rounded-2xl p-8 text-center">
            ...
            <p className="text-gray-700 mb-6">
              Every meal brings you closer to your health goals. Stay consistent and watch the rewards add up!
            </p>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <div>
                <div className="text-xl font-bold text-purple-600">{userProgress.longestStreak}</div>
                <div className="text-sm text-gray-600">Longest Streak</div>
              </div>
              <div>
                <div className="text-xl font-bold text-green-600">{userProgress.weightLost} lbs</div>
                <div className="text-sm text-gray-600">Weight Lost</div>
              </div>
              <div>
                <div className="text-xl font-bold text-blue-600">${userProgress.moneySaved}</div>
                <div className="text-sm text-gray-600">Money Saved</div>
              </div>
              <div>
                <div className="text-xl font-bold text-orange-600">{userProgress.daysActive}</div>
