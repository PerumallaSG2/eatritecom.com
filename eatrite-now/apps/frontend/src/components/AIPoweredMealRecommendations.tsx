...
const generateUserProfile = (): UserProfile => ({
  ...
  activityLevel: 'high',
  mealHistory: ['keto-salmon', 'mediterranean-bowl', 'protein-power-plate', 'veggie-stir-fry'],
  favoriteIngredients: ['Salmon', 'Avocado', 'Quinoa', 'Broccoli', 'Sweet Potato'],
  dislikedIngredients: ['Brussels Sprouts', 'Liver'],
  budget: 'standard',
  familySize: 2
});

const generateAIRecommendations = (_profile: UserProfile): MealRecommendation[] => [
  {
    id: 'ai-rec-1',
    name: 'Mediterranean Salmon Power Bowl',
    description: 'Herb-crusted salmon with quinoa, roasted vegetables, and tahini dressing - perfect for your muscle-building goals.',
    image: '🐟',
    ...
    nutritionScore: 92,
    ingredients: ['Wild Salmon', 'Quinoa', 'Broccoli', 'Avocado', 'Tahini', 'Lemon'],
    allergens: [],
  ...
  },
  {
    ...
    description: 'Creamy avocado and herb-seasoned chicken with cauliflower rice - ideal for low-carb lifestyle.',
    image: '🥑',
    cuisine: 'American',
    prepTime: 20,
    calories: 420,
    ...
    nutritionScore: 88,
    ingredients: ['Organic Chicken', 'Avocado', 'Cauliflower Rice', 'Herbs', 'Olive Oil'],
    allergens: [],
  ...
  },
  {
    ...
    description: 'Seasoned lean beef with quinoa pilaf, roasted sweet potato, and green vegetables.',
    image: '🥩',
    cuisine: 'American',
    prepTime: 30,
    calories: 520,
    ...
    nutritionScore: 90,
    ingredients: ['Grass-Fed Beef', 'Quinoa', 'Sweet Potato', 'Broccoli', 'Herbs'],
    allergens: [],
  ...
  },
  {
    ...
    description: 'Organic eggs with quinoa hash, avocado, and seasonal vegetables for sustained energy.',
    image: '🍳',
    cuisine: 'American',
    prepTime: 15,
    calories: 380,
    ...
    nutritionScore: 85,
    ingredients: ['Organic Eggs', 'Quinoa Hash', 'Avocado', 'Spinach', 'Bell Peppers'],
    allergens: ['Eggs'],
...
const generateAIInsights = (_profile: UserProfile): AIInsight[] => [
  {
    ...
    description: 'You order Mediterranean meals 40% more often than average. Consider our new Greek collection.',
    confidence: 87,
    actionable: true
  },
  {
    ...
    description: 'Your recent meals average 28g protein. Increase to 35g for better muscle building results.',
    confidence: 92,
    actionable: true
  },
  {
    ...
    description: 'Try adding more colorful vegetables to increase micronutrient variety.',
    confidence: 78,
    actionable: true
  },
  {
    ...
    description: 'Root vegetables and warming spices align well with your current preferences.',
    confidence: 71,
    actionable: false
  }
];
        ...
        <FadeIn>
          <div className="text-center">
            <div className="flex items-center justify-center space-x-3 mb-4">
              ...
              <h2 className="text-3xl font-bold">AI-Powered Meal Recommendations</h2>
        ...
        <FadeIn delay={0.1}>
          <div className="bg-white rounded-2xl p-6 mb-8 shadow-lg">
            <div className="flex items-center space-x-4 mb-4">
              ...
              <div>
                <h3 className="text-xl font-semibold text-gray-900">Welcome back, {userProfile.name}!</h3>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <div className="text-center">
                ...
                <div className="font-semibold text-purple-600 capitalize">{userProfile.activityLevel}</div>
              </div>
              <div className="text-center">
                <div className="text-sm text-gray-600">Diet Focus</div>
                <div className="font-semibold text-blue-600">{userProfile.dietaryPreferences[0]}</div>
              </div>
              <div className="text-center">
                <div className="text-sm text-gray-600">Primary Goal</div>
                <div className="font-semibold text-green-600">{userProfile.healthGoals[0]}</div>
              </div>
              <div className="text-center">
                <div className="text-sm text-gray-600">Budget</div>
                <div className="font-semibold text-orange-600 capitalize">{userProfile.budget}</div>
              </div>
            </div>
          </div>
        </FadeIn>
                ...
                {recommendations.map((meal) => (
                  <div
                    ...
                    className={`bg-white rounded-2xl p-6 shadow-lg cursor-pointer transition-all hover:shadow-xl ${
                      selectedMeal?.id === meal.id ? 'ring-2 ring-purple-500' : ''
                    }`}
                  >
                      ...
                      <div className="flex-1">
                        <div className="flex items-start justify-between mb-2">
                          ...
                          <div className="text-right">
                            <div className="text-lg font-bold text-gray-900">${meal.price}</div>
                            <div className={`text-xs px-2 py-1 rounded-full ${getConfidenceColor(meal.confidence)}`}>
              ...
              <FadeIn delay={0.3}>
                <div className="bg-white rounded-2xl p-6 shadow-lg">
                  ...
                  <div className="mt-6 pt-4 border-t border-gray-200">
                    <h4 className="font-semibold text-gray-900 mb-2">Similar Options</h4>
                    <div className="space-y-2">
                      {selectedMeal.similarMeals.map((meal, index) => (
                        <div key={index} className="text-sm text-purple-600 hover:text-purple-800 cursor-pointer">
                          • {meal}
                        </div>
                      ))}
                    </div>
