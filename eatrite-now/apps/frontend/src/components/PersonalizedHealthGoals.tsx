...
const generateHealthGoals = (): HealthGoal[] => [
  {
    ...
    description:
      'Reach target weight of 150 lbs through healthy eating and portion control',
    category: 'weight',
    targetValue: 150,
    currentValue: 162,
    unit: 'lbs',
  ...
  },
  {
    ...
    description:
      'Consume 140g of protein daily to support muscle building and recovery',
    category: 'nutrition',
    targetValue: 140,
    currentValue: 125,
    unit: 'g',
  ...
  },
  {
    ...
    description:
      'Maintain consistent energy levels throughout the day (8+ out of 10)',
    category: 'wellness',
    targetValue: 8,
    currentValue: 7.2,
    unit: '/10',
...
const generateGoalInsights = (_goals: HealthGoal[]): GoalInsight[] => [
  {
    ...
    description:
      "You're losing weight at a healthy pace of 1-2 lbs per week. Great job!",
    actionable: false,
    goalId: 'weight-loss',
  },
  {
    ...
    description:
      "You're 15g below your daily protein goal. Consider adding a protein-rich snack.",
    actionable: true,
  ...
  },
  {
    ...
    description:
      "You've had 3 non-Factor75 meals this week. Consider meal prep to stay on track.",
    actionable: true,
  ...
  },
  {
    ...
    description:
      "You're 0.8 points away from your energy level target. Keep up the good work!",
    actionable: false,
    goalId: 'energy-level',
  },
]
...
export const PersonalizedHealthGoals: React.FC = () => {
  ...
  const [_progressData, _setProgressData] = useState<
  ...
  const generateProgressHistory = (goal: HealthGoal): ProgressEntry[] => {
    ...
    for (let i = 0; i <= daysDiff; i++) {
      ...
      const value =
        goal.currentValue + currentProgress + (Math.random() - 0.5) * 2
                    ...
                    >
                      <div className="flex items-start justify-between mb-4">
                        <div className="flex items-center space-x-4">
                          <div
                            className={`w-12 h-12 bg-${goal.color}-100 rounded-xl flex items-center justify-center`}
                          >
                            <IconComponent
                              className={`w-6 h-6 text-${goal.color}-600`}
                            />
                          </div>
                          <div>
                        ...
                        <div className="flex items-center space-x-2">
                          <span
                            className={`px-3 py-1 rounded-full text-xs font-semibold ${getPriorityColor(goal.priority)}`}
                          >
                            {goal.priority} priority
                          </span>
                          <span
                            className={`px-3 py-1 rounded-full text-xs font-semibold ${getStatusColor(goal.status)}`}
                          >
                            {goal.status.replace('-', ' ')}
                          </span>
                        </div>
                      ...
                      <div className="mb-4">
                        <div className="flex items-center justify-between mb-2">
                          <span className="text-sm font-medium text-gray-700">
                            ...
                            {goal.unit} → Target: {goal.targetValue}
                            {goal.unit}
                          </span>
                          <span
                            className={`text-sm font-bold text-${goal.color}-600`}
                          >
              ...
              <div className="bg-white rounded-2xl p-6 shadow-lg">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <span
                      className={`font-semibold text-${selectedGoal.color}-600`}
                    >
