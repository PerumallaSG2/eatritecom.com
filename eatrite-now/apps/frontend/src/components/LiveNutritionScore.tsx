...
const nutritionMetrics: NutritionMetric[] = [
  {
    ...
    color: 'blue',
    unit: 'score',
    description: 'High-quality, complete proteins with optimal amino acid profiles'
  },
  {
    ...
    color: 'purple',
    unit: 'score',
    description: 'Maximum nutrients per calorie with vitamins, minerals, and antioxidants'
  },
  {
    name: 'Sodium Control',
    factor75Score: 88,
...
const comparisonData: ComparisonData[] = [
  { category: 'Daily Vegetables', factor75: 5.2, fastFood: 0.8, restaurant: 2.1, homeCooking: 3.4 },
  { category: 'Fiber (g)', factor75: 28, fastFood: 8, restaurant: 12, homeCooking: 18 },
  { category: 'Added Sugar (g)', factor75: 6, fastFood: 35, restaurant: 22, homeCooking: 15 },
  { category: 'Omega-3 (mg)', factor75: 1200, fastFood: 150, restaurant: 400, homeCooking: 600 },
  { category: 'Antioxidants (ORAC)', factor75: 8500, fastFood: 1200, restaurant: 3200, homeCooking: 4800 }
];

export const LiveNutritionScore: React.FC = () => {
  const [selectedMetric, setSelectedMetric] = useState<NutritionMetric>(nutritionMetrics[0]);
  const [animatedScores, setAnimatedScores] = useState({ factor75: 0, fastFood: 0, restaurant: 0 });
  const [overallScore, setOverallScore] = useState(0);

  useEffect(() => {
    // Calculate overall Factor75 score
    const total = nutritionMetrics.reduce((sum, metric) => sum + metric.factor75Score, 0);
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-center space-x-4">
                        ...
                        <div className={`text-right ${getScoreColor(metric.factor75Score)}`}>
                          <div className="text-2xl font-bold">{metric.factor75Score}</div>
          ...
          <div>
            <FadeIn delay={0.3}>
              ...
              <div className="space-y-6">
                {/* Factor75 Score */}
                <div className={`p-6 rounded-xl border-2 ${getScoreBg(selectedMetric.factor75Score)}`}>
                  <div className="flex items-center justify-between mb-3">
                    <h4 className="font-bold text-lg text-gray-900">Factor75</h4>
                    <div className={`text-3xl font-bold ${getScoreColor(selectedMetric.factor75Score)}`}>
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="text-sm text-gray-700">Professionally optimized</span>
                  </div>
                </div>

                {/* Restaurant Score */}
                <div className={`p-6 rounded-xl border-2 ${getScoreBg(selectedMetric.restaurantScore)}`}>
                  <div className="flex items-center justify-between mb-3">
                    <h4 className="font-bold text-lg text-gray-900">Restaurant Meals</h4>
                    <div className={`text-3xl font-bold ${getScoreColor(selectedMetric.restaurantScore)}`}>
                  ...
                  <span className="text-sm text-gray-600">Inconsistent quality</span>
                </div>

                {/* Fast Food Score */}
                <div className={`p-6 rounded-xl border-2 ${getScoreBg(selectedMetric.fastFoodScore)}`}>
                  <div className="flex items-center justify-between mb-3">
                    <h4 className="font-bold text-lg text-gray-900">Fast Food</h4>
                    <div className={`text-3xl font-bold ${getScoreColor(selectedMetric.fastFoodScore)}`}>
                  ...
                  <span className="text-sm text-gray-600">Highly processed</span>
                </div>
              </div>
            </FadeIn>
            ...
            <FadeIn delay={0.4}>
              <div className="mt-8 bg-white rounded-xl p-6 shadow-lg">
                <h4 className="font-semibold text-gray-900 mb-4">Nutritional Breakdown</h4>
                      ...
                      <div className="flex justify-between items-center">
                        ...
                        <div className="flex space-x-4 text-sm">
                          <span className="text-green-600 font-semibold">
                            Factor75: {item.factor75}{item.category.includes('Daily') ? '' : 
                            item.category.includes('ORAC') ? '' : 
                            item.category.includes('(g)') ? 'g' : 
                            item.category.includes('(mg)') ? 'mg' : ''}
                          </span>
                          <span className="text-red-600">
                            Fast Food: {item.fastFood}{item.category.includes('Daily') ? '' : 
                            item.category.includes('ORAC') ? '' : 
                            item.category.includes('(g)') ? 'g' : 
                            item.category.includes('(mg)') ? 'mg' : ''}
                          </span>
          ...
          <div className="mt-8 bg-white rounded-xl p-6 shadow-lg">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="text-center">
                ...
                <h5 className="font-semibold text-gray-900 mb-2">Chef-Crafted</h5>
              ...
              <div className="text-center">
                ...
                <h5 className="font-semibold text-gray-900 mb-2">Premium Ingredients</h5>
                <p className="text-sm text-gray-600">
              ...
              <div className="text-center">
                ...
                <h5 className="font-semibold text-gray-900 mb-2">Precision Nutrition</h5>
                <p className="text-sm text-gray-600">
