...
const IconBase: React.FC<IconProps & { children: React.ReactNode; viewBox?: string }> = ({
  ...
  return (
    <svg
      ...
      style={{ filter: color === 'gold' ? 'drop-shadow(0 0 4px rgba(212, 160, 71, 0.3))' : undefined }}
    >
      {children}
    </svg>
  );
...
export const ThreeLeavesIcon: React.FC<IconProps> = (props) => (
  <IconBase {...props} viewBox="0 0 32 32">
    ...
    <ellipse cx="16" cy="12" rx="3" ry="8" fill="currentColor" stroke="currentColor" />
    {/* Left angled leaf */}
    <ellipse cx="10" cy="18" rx="2.5" ry="6" fill="currentColor" stroke="currentColor" transform="rotate(-35 10 18)" />
    {/* Right angled leaf */}
    <ellipse cx="22" cy="18" rx="2.5" ry="6" fill="currentColor" stroke="currentColor" transform="rotate(35 22 18)" />
  </IconBase>
);
