        ...
        <div className="fixed inset-0 z-50 overflow-hidden">
          ...
          <div className="absolute right-0 top-0 h-full w-full max-w-md bg-white shadow-2xl transform transition-transform duration-300 flex flex-col">
            ...
            <div className="flex items-center justify-between p-6 border-b border-gray-200 bg-green-600 text-white">
              <div>
                <h2 className="text-xl font-bold" style={{ fontFamily: 'source-sans-pro, sans-serif' }}>
                  Your Cart
                </h2>
                <p className="text-green-100 text-sm">{totalItems} item{totalItems !== 1 ? 's' : ''}</p>
              </div>
              <button
                onClick={() => setIsOpen(false)}
                ...
                <div key={item.id} className="bg-gray-50 rounded-lg p-4 border border-gray-200 hover:shadow-md transition-shadow">
                  <div className="flex items-center space-x-4">
                    ...
                    <div className="flex-1 min-w-0">
                      <h3 className="font-semibold text-gray-900 text-sm truncate" style={{ fontFamily: 'source-sans-pro, sans-serif' }}>
                        {item.name}
                      </h3>
            ...
            <div className="border-t border-gray-200 p-6 bg-gray-50">
              ...
              <div className="space-y-3">
                <button className="w-full bg-green-600 hover:bg-green-700 text-white font-bold py-4 px-6 rounded-lg transition-all duration-200 transform hover:scale-105 active:scale-95 shadow-md hover:shadow-lg"
