...
const LivingFoodCard = ({ meal, userHealthGoal = 'wellness', onAddToCart }: LivingFoodCardProps) => {
              ...
              <div className="p-4 w-full">
                <div className="grid grid-cols-4 gap-2 text-white text-xs">
                  <div className="text-center">
                    <div className="w-6 h-6 mx-auto mb-1 rounded-full" style={{ background: '#E17055' }}></div>
                    <div>{meal.protein}g</div>
                    <div className="opacity-75">Protein</div>
                  </div>
                  <div className="text-center">
                    <div className="w-6 h-6 mx-auto mb-1 rounded-full" style={{ background: '#FDCB6E' }}></div>
                    <div>{meal.carbs}g</div>
                    <div className="opacity-75">Carbs</div>
                  </div>
                  <div className="text-center">
                    <div className="w-6 h-6 mx-auto mb-1 rounded-full" style={{ background: '#6C5CE7' }}></div>
                    <div>{meal.fats}g</div>
                    <div className="opacity-75">Fats</div>
                  </div>
                  <div className="text-center">
                    <div className="w-6 h-6 mx-auto mb-1 rounded-full" style={{ background: '#00B894' }}></div>
      ...
      <div className="p-6">
        ...
        <div className="mb-4">
          <div className="flex justify-between text-sm text-gray-600 mb-1">
            ...
            <span className="font-medium">{Math.round((meal.protein + meal.fiber) * 2)}%</span>
          </div>
          <div className="h-2 bg-gray-200 rounded-full overflow-hidden">
            <motion.div
              initial={{ width: 0 }}
              animate={{ width: `${Math.round((meal.protein + meal.fiber) * 2)}%` }}
        ...
        <div className="flex items-center justify-between">
          <div>
            <span className="text-2xl font-bold text-gray-800">${meal.price}</span>
