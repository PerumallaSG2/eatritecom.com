...
export const EatRiteThemeProvider: React.FC<EatRiteThemeProviderProps> = ({
  children,
}) => {
...
export const useEatRiteTheme = (): EatRiteTheme => {
  ...
  if (!theme) {
    throw new Error(
      'useEatRiteTheme must be used within an EatRiteThemeProvider'
    )
  }
...
export const EatRiteStyleProvider: React.FC<{ children: ReactNode }> = ({
  children,
}) => {
  React.useEffect(() => {
...
export const EatRiteProvider: React.FC<{ children: ReactNode }> = ({
  children,
}) => {
  return (
    <EatRiteThemeProvider>
      <EatRiteStyleProvider>{children}</EatRiteStyleProvider>
    </EatRiteThemeProvider>
  )
}
