...
export const eatRiteTheme = {
  ...
  shadows: {
    ...
    goldGlow:
      '0 0 20px rgba(212, 160, 71, 0.3), 0 0 40px rgba(212, 160, 71, 0.1)',
  ...
  gradients: {
    ...
    goldSubtle:
      'linear-gradient(135deg, #f4c43020 0%, #d4a04720 50%, #b8832d20 100%)',
    ...
    blackToGold:
      'linear-gradient(135deg, #000000 0%, #171717 50%, #d4a047 100%)',
